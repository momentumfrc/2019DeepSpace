...
public class ControllerBase implements DriveController {
  ...
  static final double ARM_CURVE = 2.5;
  static final double WRIST_CURVE = 2.5;
  ...
  static final double MAX_ARM_SPEED_UP = 1;
  static final double MAX_ARM_SPEED_DOWN = 1;

  boolean lastPresetUpPressed = false;
  boolean lastPresetDownPressed = false;
